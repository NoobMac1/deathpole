...
namespace Vars
{
	...
	namespace Visuals
	{
		...
		inline CVar<int> XOffset{ 0, L"Viewmodel X Offset" };
		inline CVar<int> YOffset{ 0, L"Viewmodel Y Offset" };
		inline CVar<int> ZOffset{ 0, L"Viewmodel Z Offset" };
		inline CVar<int> VMRoll{ 0, L"Viewmodel Roll" };
	...
	namespace Misc
	{
		...
		namespace CL_Move
		{
			...
			inline CVar<int> DoubletapAmt		{ 20, L"Tick Amount" };
