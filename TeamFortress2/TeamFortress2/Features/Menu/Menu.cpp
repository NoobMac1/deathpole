...
void CMenu::Run()
{
	...
	if (m_bOpen || m_flFadeElapsed < m_flFadeDuration)
	{
		...
		//Do the Watermark
		{
			...
			g_Draw.Rect(20, 30, 145, (g_Draw.m_vecFonts[FONT_MENU].nTall * 3) + 5, Vars::Menu::Colors::WindowBackground);
		...
		//Do the Widgets
		{
			...
			switch (Tab)
			{
					...
					switch (Tab)
					{
						case EAimTabs::TAB_AIMBOT:
						{
							...
							GroupBoxStart();
							{
								...
								CheckBox(Vars::Misc::CL_Move::DoubletapProj, _(L"Shift tickbase with projectiles"));
							}
						...
						case EAimTabs::TAB_OTHER:
						{
							GroupBoxStart();
							{
								CheckBox(Vars::Misc::DisableInterpolation, _(L"Remove interpolation"));
					...
					switch (Tab)
					{
						...
						case EVisualsTabs::TAB_CHAMS:
						{
							...
							GroupBoxStart();
							{
								...
								ComboBox(Vars::Chams::Players::Material, { { 0, _(L"None") }, { 1, _(L"Shaded") }, { 2, _(L"Shiny") }, { 3, _(L"Flat") }, { 4, _(L"Fresnel") } });
							...
							GroupBoxStart();
							{
								...
								ComboBox(Vars::Chams::Buildings::Material, { { 0, _(L"None") }, { 1, _(L"Shaded") }, { 2, _(L"Shiny") }, { 3, _(L"Flat") }, { 4, _(L"Fresnel") } });
							...
							GroupBoxStart();
							{
								...
								ComboBox(Vars::Chams::World::Material, { { 0, _(L"None") }, { 1, _(L"Shaded") }, { 2, _(L"Shiny") }, { 3, _(L"Flat") }, { 4, _(L"Fresnel") } });
						...
						case EVisualsTabs::TAB_OTHER:
						{
							...
							GroupBoxStart();
							{
								...
								ComboBox(Vars::Visuals::Skins::Sheen, {
									...
									{ 7, L"Hot Rod" } });
								CheckBox(Vars::Visuals::Skins::Acient, _(L"Ancient"));
					...
					switch (Tab)
					{
						case EMiscTabs::TAB_MAIN:
						{
							GroupBoxStart();
							{
								...
								CheckBox(Vars::Misc::ChatSpam, _(L"Chat Spam)"));
								CheckBox(Vars::Misc::NoPush, _(L"Prevent players from pushing you"));
								CheckBox(Vars::Misc::CheatBypass, _(L"Force sv_cheats to 1"));
							}
							GroupBoxEnd(_(L"Main"), 210);
							...
							GroupBoxStart();
							{
								CheckBox(Vars::Misc::CL_Move::SEnabled, _(L"Master switch to enable speedhack."));
						...
						case EMiscTabs::TAB_HVH:
						{
							GroupBoxStart();
							{
								...
								{
									CMenu::InputInt(Vars::AntiHack::AntiAim::YawRealOffset, -180, 180);
								};
								ComboBox(Vars::AntiHack::AntiAim::YawFake, { { 0, _(L"None") }, { 1, _(L"Left") }, { 2, _(L"Right") }, { 3, _(L"Backwards") }, { 4, _(L"Custom") } });
								if (Vars::AntiHack::AntiAim::YawFake.m_Var == 4)
								{
									CMenu::InputInt(Vars::AntiHack::AntiAim::YawFakeOffset, -180, 180);
								};
								if (Vars::AntiHack::AntiAim::YawReal.m_Var == 1 || Vars::AntiHack::AntiAim::YawReal.m_Var == 2 || Vars::AntiHack::AntiAim::YawFake.m_Var == 1 || Vars::AntiHack::AntiAim::YawFake.m_Var == 2)
								{
									InputKey(Vars::AntiHack::AntiAim::InvertKey);
								};
							}
				...
				case EMainTabs::TAB_CONFIGS:
				{
					...
					{
						if (std::string(std::filesystem::path(entry).filename().string()).find(_(".dpc")) == std::string_view::npos)
							continue;
