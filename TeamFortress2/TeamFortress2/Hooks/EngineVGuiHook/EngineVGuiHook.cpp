				...
				if (Vars::Misc::CL_Move::Enabled.m_Var)
				{
					...
					if (pLocal && pWeapon)
					{
						if (pLocal->GetLifeState() == LIFE_ALIVE)
						{
							...
							{
								g_Draw.OutlinedRect(g_ScreenSize.c, g_ScreenSize.c - 10, 8, 12, { 255, 64, 64, 255 });
							...
							{
								g_Draw.OutlinedRect(g_ScreenSize.c, g_ScreenSize.c - 10, 8, 12, { 255, 178, 0, 255 });
							...
							{
								g_Draw.OutlinedRect(g_ScreenSize.c, g_ScreenSize.c - 10, 8, 12, { 25, 255, 25, 255 });
